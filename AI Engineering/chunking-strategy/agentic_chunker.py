...
class ChunkSelection(BaseModel):
    """The existing chunk selected for a proposition, if one applies."""

    chunk_id: Optional[str] = Field(
        default=None,
        description='Existing chunk id, or null if the proposition should start a new chunk.',
    )


class AgenticChunker:
    def __init__(self, openai_api_key=None, model=DEFAULT_OPENAI_MODEL):
        self.chunks = {}
        ...
        self.chunk_selector = self.llm.with_structured_output(ChunkSelection)
    ...
    def _find_relevant_chunk(self, proposition):
        ...
        runnable = PROMPT | self.chunk_selector
